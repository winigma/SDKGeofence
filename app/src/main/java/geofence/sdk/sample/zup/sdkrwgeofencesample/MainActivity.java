...
public class MainActivity extends AppCompatActivity
        ...
        GoogleMap.OnMarkerClickListener, GeofenceCallback {
    ...
    public void onMapClick(LatLng latLng) {
       /// Log.d(TAG, "onMapClick(" + latLng + ")");
        double lat = -18.9332092;
        double lng = -48.2748613;
        LatLng latLng2 = new LatLng(lat, lng);
        markerForGeofence(latLng2);
    }
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        getLastKnownLocation();
        RWGeofenceController.create(this, getApplicationContext(), lastLocation,LocationServices.getGeofencingClient(this) );
